...
function(e) {
    ...
    f.prototype = {
        ...
        defaultMessages: {
            ...
            email: "Введте правильный email адресс",
        ...
        clearErrors: function() {
            ...
            for (var r = 0, n = e.length; r < n; ++r) e[r].classList.remove("js-validate-error-field"),$(e[r]).parent('.form-p').find('.error-icon').removeClass('active') ,e[r].style.border = "", e[r].style.color = ""
        },
        renderErrors: function() {
            ...
            for (var t in this.result) {
                ...
                if (o.innerHTML = i, o.className = "js-validate-error-label", o.setAttribute("style", "color: " + this.colorWrong), n.style.border = "1px solid " + this.colorWrong, n.style.color = "" + this.colorWrong, n.classList.add("js-validate-error-field"),  $(n).parent('.form-p').find('.error-icon').addClass('active'), "checkbox" === n.type || "radio" === n.type) {
